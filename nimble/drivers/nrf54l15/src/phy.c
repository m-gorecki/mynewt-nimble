...
//#define OUTPUT_PIN 288
//const nrfx_gpiote_t gpiote = NRFX_GPIOTE_INSTANCE(130);
//static uint8_t ppi_channel;
//static uint8_t ppi_channel2;
//static uint8_t out_channel;
...
//    NRF_DPPIC10->CHENSET = DPPI_CH_MASK(RADIO_EVENTS_READY);

    NRF_DPPIC10->CHENSET = DPPIC_CHEN_CH0_Msk | DPPIC_CHEN_CH1_Msk | DPPIC_CHEN_CH2_Msk | DPPIC_CHEN_CH3_Msk |
                           DPPIC_CHEN_CH4_Msk | DPPIC_CHEN_CH5_Msk | DPPIC_CHEN_CH6_Msk | DPPIC_CHEN_CH7_Msk |
                           DPPIC_CHEN_CH8_Msk | DPPIC_CHEN_CH9_Msk;
    NRF_DPPIC20->CHENSET = DPPIC_CHEN_CH0_Msk | DPPIC_CHEN_CH1_Msk | DPPIC_CHEN_CH2_Msk | DPPIC_CHEN_CH3_Msk |
                           DPPIC_CHEN_CH4_Msk | DPPIC_CHEN_CH5_Msk | DPPIC_CHEN_CH6_Msk | DPPIC_CHEN_CH7_Msk;

    NRF_PPIB11->SUBSCRIBE_SEND[6] = DPPI_CH_SUB(TIMER0_EVENTS_COMPARE_0);
    NRF_PPIB11->SUBSCRIBE_SEND[7] = DPPI_CH_SUB(RADIO_EVENTS_READY);

    NRF_PPIB21->PUBLISH_RECEIVE[6] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_0);
    NRF_PPIB21->PUBLISH_RECEIVE[7] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_1);

    NRF_GPIOTE20->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_1] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_0);
    NRF_GPIOTE20->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_1] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_1);
#endif
    ...
    NRF_PPIB11->SUBSCRIBE_SEND[4] = DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);
    NRF_PPIB11->SUBSCRIBE_SEND[5] = DPPI_CH_SUB(RADIO_EVENTS_END);

    NRF_PPIB21->PUBLISH_RECEIVE[4] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_2);
    NRF_PPIB21->PUBLISH_RECEIVE[5] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_3);

    NRF_GPIOTE20->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_2] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_2);
    NRF_GPIOTE20->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_2] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_3);
...
//
//    NRF_PPIB11->SUBSCRIBE_SEND[2] = DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);
//    NRF_PPIB11->SUBSCRIBE_SEND[3] = DPPI_CH_SUB(RADIO_EVENTS_END);
//
//    NRF_PPIB21->PUBLISH_RECEIVE[2] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_4);
//    NRF_PPIB21->PUBLISH_RECEIVE[3] = DPPI_CH_PUB(IPCT130_EVENTS_RECEIVE_5);
//
//    NRF_GPIOTE20->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_3] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_4);
//    NRF_GPIOTE20->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_3] = DPPI_CH_SUB(IPCT130_EVENTS_RECEIVE_5);
//
...
phy_ppi_init(void)
{
    ...
    NRF_PPIB00->PUBLISH_RECEIVE[0] = DPPI_CH_PUB(RADIO_EVENTS_PAYLOAD_CCM);

    /* Enable channels we publish on */
    NRF_DPPIC->CHENSET = DPPI_CH_ENABLE_ALL;
    NRF_DPPIC00->CHENSET = DPPIC_CHEN_CH0_Msk;
